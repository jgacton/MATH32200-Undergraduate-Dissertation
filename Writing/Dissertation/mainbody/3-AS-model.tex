...
By substitution of \textcite{AS2008}'s ansatz \eqref{eq:3.18} into 
...
derived in an intuitive two-step procedure. First, we solve the HJB equation \eqref{eq:3.19}
...
through the asymptotic approximation used to yield the final results that \textcite{AS2008}
have presented. 

In the next chapter, we will provide code and results for the
numerical simulation results that \textcite{AS2008} describe, attaining results 
