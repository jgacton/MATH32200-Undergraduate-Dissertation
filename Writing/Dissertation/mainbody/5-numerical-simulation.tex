...
\begin{figure}[ht!]
    \centering
        \includegraphics[width=0.5\linewidth]{sample-path.png}
...
\begin{figure}[ht!]
    ...
    \begin{minipage}{.5\textwidth}
        ...
        \captionof{figure}{Sample inventory for $\gamma=0.1$}
        \label{fig:inventory}
    \end{minipage}%
    \begin{minipage}{.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{wealth.png}
        \captionof{figure}{Sample profit for $\gamma=0.1$}
        \label{fig:pnl}
    \end{minipage}
\end{figure}
