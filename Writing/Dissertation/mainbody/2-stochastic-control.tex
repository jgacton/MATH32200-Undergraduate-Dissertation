...
to prove the results of \textcite{AS2008} in chapter \ref{chap:3}, and we primarily follow 
...
\end{equation}
From Chapter \ref{chap:1} (theorem \ref{thm:1.6.1}), conditions \eqref{eq:2.2} and \eqref{eq:2.3} ensure the existence
...
\begin{proof}[Proof of the DPP]
    ...
    however one example of this can be found in Chapter 7 of \textcite{BeSh78}.
...
to $\theta$, as given in \eqref{eq:2.16}. The magic in this is that we are not limited 
...
section \ref{sec:1.2}, and building up the model given by \textcite{AS2008}.
